    ...
    <form method="post" action="helpmeUpdate.bo" enctype="multipart/form-data">
        ...
        <table align="center">
            ...
            <tr>
                <th>내용</th>
                <td colspan="3">
                    <textarea name="boardContent" rows="5"  style="resize: none;" >${b.boardContent}</textarea>
                </td>
            </tr>
            <tr>
                <th>대표이미지</th>
            ...
            <tr>
                <th>희망가격</th>
                <td colspan="2">
                    <input class="hu-price" type="number" id="price" name="price" placeholder="최소1,000" value="${b.price}" oninput="money()">
                </td>
                <td>원</td>
            </tr>
            <tr>
