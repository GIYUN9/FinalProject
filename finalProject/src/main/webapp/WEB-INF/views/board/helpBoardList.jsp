				  ...
				  <c:if test="${lType eq 'helpList.bo'}">
					...
					<c:if test="${lType eq 'helpDateList'}">
				  	<c:choose>
				  		...
				  		<c:otherwise>
                    		<li class="page-item"><a class="page-link" href="helpDateList?cpage=${ pi.currentPage - 1 }">&laquo;</a></li>
                    	</c:otherwise>
				  	</c:choose>
				    
				    <c:forEach var="h" begin="${pi.startPage}" end="${ pi.endPage }">
				    	<li class="page-item"><a class="page-link" href="helpDateList?cpage=${ h }">${ h }</a></li>
				    </c:forEach>
				    <c:choose>
				    	<c:when test="${ pi.currentPage eq pi.maxPage }">
				    		<li class="page-item disabled"><a class="page-link">&raquo;</a></li>
				    	...
				    	<c:otherwise>
				    		<li class="page-item"><a class="page-link" href="helpDateList?cpage=${ pi.currentPage + 1 }">&raquo;</a></li>
				    	</c:otherwise>
				    </c:choose>
				   </c:if>
